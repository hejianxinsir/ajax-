...
var server = http.createServer(function(request, response){
		...
		const testJs = fs.readFileSync('./main.js')
		...
		response.statusCode = 200
		response.setHeader('Content-Type', 'text/html;charset=utf-8')
		response.write(fs.readFileSync('./index2.html'))
		response.end()
		}else if(path === '/index3.html'){
		response.statusCode = 200
		response.setHeader('Content-Type', 'text/html;charset=utf-8')
		response.write(fs.readFileSync('./index3.html'))
		response.end()
		}else if(path === '/4.xml'){
		response.statusCode = 200
		...
		response.end()
		}else if(path === '/hehe.json'){
		response.statusCode = 200
		response.setHeader('Content-Type', 'text/json;charset=utf-8')
		response.write(fs.readFileSync('./hehe.json'));
		response.end()
